package com.Vendedores.bibliotecaduoc.controller;

import com.ejemplo.vendedores.entity.Vendedor;
import com.ejemplo.vendedores.service.VendedorService;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import jakarta.validation.Valid; // Para validar el cuerpo de la solicitud
...
public class VendedorController {
     ...
     */
    @PostMapping
    public ResponseEntity<?> crearVendedor(@Valid @RequestBody Vendedor vendedor) { 
        try {
     ...
     */
    @PutMapping("/{id}")
    public ResponseEntity<Vendedor> actualizarVendedor(@PathVariable Long id, @Valid @RequestBody Vendedor vendedor) { 
